                                                                                                                                        ...
                                                                                                                                        serverDeferred.request("PL_MDVIEW_004", { systemmetagroupid: "1613634433158205", stateRegNumber: response[1].uniqueidentifier.toUpperCase() }).then(function(response) {
                                                                                                                                            ...
                                                                                                                                            if (response[0] == "") {
                                                                                                                                                ...
                                                                                                                                                serverDeferred.requestFull("dcApp_basePerson_002", $scope.basePersonData).then(function(response) {
                                                                                                                                                    ...
                                                                                                                                                    $rootScope.alert("Амжилттай", "success", "profile"); $scope.getProfileData();
                                                                                                                                                });
                                                                                                                                ...
                                                                                                                                $scope.saveIncomeProfileData = function() {
                                                                                                                                        if (isEmpty($scope.customerIncomeProfileData.incometypeid)) {
                                                                                                                                            ...
                                                                                                                                            $timeout(function() {
                                                                                                                                                ...
                                                                                                                                                ); localStorage.removeItem("profilePictureSideMenu"); localStorage.setItem("profilePictureSideMenu", $scope.customerProfilePicture.profilepicture);
                                                                                                                                            };
                                                                                                                                                        ...
                                                                                                                                                        $timeout(function() {
                                                                                                                                                                    if ($scope.customerIncomeProfileData != "") {
                                                                                                                                                                        ...
                                                                                                                                                                        serverDeferred.requestFull("dcApp_profile_dv_002", $scope.customerProfileData).then(function(response) {
                                                                                                                                                                                ...
                                                                                                                                                                                }; $("#productYear").mask("0000"); $("#entryYear").mask("0000"); $("#odo").mask("000000000"); $("#nationalNumber").mask("0000 AAA", {
                                                                                                                                                                                    translation: {
                                                                                                                                                                                        A: { pattern: /^[А-ЯӨҮа-яөү\-\s]+$/ },
                                                                                                                                                                                    },
                                                                                                                                                                                }); $rootScope.customerCar = []; $scope.companyData = []; $scope.carmerkData = []; $scope.getCompanyData = function() {
                                                                                                                                                                                ...
                                                                                                                                                                                }; $scope.getCompanyData(); $scope.saveCustomerCar = function() {
                                                                                                                                                                                    //console.log("saveCustomerCar");
                                                                                                                                                                                }; $scope.clickReg = function() {};
                                                                                                                                                                                var keyInput; $ionicPlatform.ready(function() {
                                                                                                                                                                                        setTimeout(function() {
