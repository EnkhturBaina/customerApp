angular.module("autoleasing.Ctrl", ["ngAnimate"]).controller("autoleasingCtrl", function($scope, serverDeferred, $rootScope, $state, $ionicHistory) {
    ...
    $scope.getCustomerId = function() {
        if (!isEmpty($rootScope.loginUserInfo) && !isEmpty($rootScope.loginUserInfo.id)) {
