angular
  ...
  .controller(
    ...
    function (
      ...
      $rootScope.serverUrl =
        "http://leasing.digitalcredit.mn:8080/erp-services/RestWS/runJsonz";
      ...
      $scope.getBanner = function () {
        document.getElementsByTagName("ion-nav-bar")[0].style.visibility =
          "hidden";
        serverDeferred
          .requestFull("PL_MDVIEW_004", {
            systemmetagroupid: "1597631698242718",
          })
          .then(function (data) {
            // console.log(data);
      ...
      $scope.endSlideChanged = function (index) {
        $ionicSlideBoxDelegate.slide(
          Object.keys($rootScope.bannerData).length - 1,
          0
        );
      };
      ...
      $scope.isNotShow = function () {
        if ($scope.isBanneNotShowChecked.checked == true) {
          localStorage.setItem(
            "bannerNotShow",
            JSON.stringify($scope.isBanneNotShowChecked.checked)
          );
        } else {
      ...
      $rootScope.alert = function (messege, checkmark, then) {
        ...
        if (checkmark == "success") {
          ...
          template =
            "<style>.popup { text-align:center;}</style>" + messege + "";
        }
      ...
      $scope.getProfileLookupData = function () {
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1554263831966" })
          .then(function (response) {
            $rootScope.mortgageData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "21553236817016" })
          .then(function (response) {
            $rootScope.familtStatData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1554274244505" })
          .then(function (response) {
            $rootScope.incomeType = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1620623825290326" })
          .then(function (response) {
            $rootScope.experiencePeriodData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1621830937132722" })
          .then(function (response) {
            $rootScope.consumerSuppliers = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1613011719373208" })
          .then(function (response) {
        ...
        // });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1628487627246231" })
          .then(function (response) {
            if (!isEmpty(response)) {
              $rootScope.suppliersWithCategory = response.filter(
                (value) => Object.keys(value).length !== 0
              );
            }
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1628559883022530" })
          .then(function (response) {
            if (!isEmpty(response)) {
              $rootScope.dcSuppliers = response.filter(
                (value) => Object.keys(value).length !== 0
              );
            }
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "16269370387471" })
          .then(function (response) {
            if (!isEmpty(response)) {
              $rootScope.supplierConditions = response.filter(
                (value) => Object.keys(value).length !== 0
              );
            }
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "16269369396661" })
          .then(function (response) {
            if (!isEmpty(response)) {
              $rootScope.supplierConditionsNotMap = response.filter(
                (value) => Object.keys(value).length !== 0
              );
            }
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1629173002695086" })
          .then(function (response) {
            if (!isEmpty(response)) {
              $rootScope.educationData = response.filter(
                (value) => Object.keys(value).length !== 0
              );
            }
          });
        ...
        // });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1634724795622863" })
          .then(function (response) {
            $timeout(function () {
              if (
                ionic.Platform.platform() == "android" ||
                ionic.Platform.platform() == "win32"
              ) {
        ...
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1636343385639929" })
          .then(function (response) {
        ...
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1646622257271491" })
          .then(function (response) {
            $rootScope.customerSector = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "16429945436111" })
          .then(function (response) {
            $rootScope.customerAreasOfActivity = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "16429945437301" })
          .then(function (response) {
            $rootScope.customerJobPosition = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "16431697956661" })
          .then(function (response) {
            $rootScope.buildingLoanTypeData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1618473508871492" })
          .then(function (response) {
            $rootScope.propertyCategory = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1613363794516634" })
          .then(function (datas) {
            delete datas.aggregatecolumns;
            $rootScope.carCategory = datas;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1645754816241863" })
          .then(function (datas) {
            delete datas.aggregatecolumns;
            $rootScope.carNumberTaken = datas;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1613364305380357" })
          .then(function (datas) {
            delete datas.aggregatecolumns;
            $rootScope.carFactoryData = datas;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1613364325545258" })
          .then(function (datas) {
            delete datas.aggregatecolumns;
            $rootScope.carModelData = datas;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "164490994564810" })
          .then(function (response) {
            $rootScope.coBorrowerData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "164490995509910" })
          .then(function (response) {
            $rootScope.ecoLoanCategoryData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "164491108544910" })
          .then(function (response) {
            $rootScope.ecoLoanStoreData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1645435285663193" })
          .then(function (response) {
            $rootScope.incomeTypeWithCondition = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "16430027914932" })
          .then(function (response) {
            $rootScope.isCarSelection = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "164612642423810" })
          .then(function (response) {
            $rootScope.proveIncomeData = response;
          });
        serverDeferred
          .request("PL_MDVIEW_004", { systemmetagroupid: "1649731248094570" })
          .then(function (response) {
      ...
      $rootScope.profilePictureSideMenu = localStorage.getItem(
        "profilePictureSideMenu"
      );
      ...
      $scope.$on("$ionicView.loaded", function (ev, info) {
        ...
        function onOffline() {
          ...
          $ionicPopup.show({
            template:
              "<b>Оффлайн горимд ажиллах боломжгүй. Та интернэт холболтоо шалгана уу</b>",
            cssClass: "confirmPopup",
            buttons: [
              {
                text: "Oкей",
        ...
        if (isEmpty($rootScope.loginUserInfo)) {
          ...
          $rootScope.loginUserInfo = JSON.parse(
        ...
        if (!isEmpty($rootScope.loginUserInfo) && !isEmpty(all_ID)) {
          serverDeferred
            .request("PL_MDVIEW_004", {
              ...
              crmcustomerid: all_ID.crmuserid,
            })
            .then(function (response) {
          ...
          if (
            ...
            $rootScope.loginUserInfo.lastname &&
            $rootScope.loginUserInfo.firstname
          ) {
            $rootScope.sidebarUserName =
              $rootScope.loginUserInfo.lastname.substr(0, 1) +
              ". " +
              $rootScope.loginUserInfo.firstname;
          }
          ...
          $timeout(function () {
            if (
              ...
              if (
                !isEmpty($rootScope.ERPappVersion) &&
                $rootScope.zeelmeAppVersion === $rootScope.ERPappVersion
              ) {
              } else {
              ...
              if (
                !isEmpty($rootScope.ERPappVersionIOS) &&
                $rootScope.zeelmeAppVersion === $rootScope.ERPappVersionIOS
              ) {
              } else {
          ...
          $timeout(function () {
            ...
            $ionicSlideBoxDelegate
              .$getByHandle("suppliersDelegate")
              .slide($scope.slideIndex);
          }, 100);
      ...
      $rootScope.checkisUpdate = function () {
        ...
        template =
          "<div class='emoji-container'>😃</div>" +
          "<div class='pop-up-text-container'>" +
          "Шинэ хувилбар гарсан байна шинэчилнэ үү!" +
          "</div>";
        $scope.alertPopup = $ionicPopup.alert({
          title: "",
          template: template,
          ...
          buttons: [
            {
              ...
              onTap: function (e) {
                ...
                if (ionic.Platform.platform() == "android") {
                  var deviceType = "market://details?id=com.zeelme.app";
                } else {
                  var deviceType =
                    "itms-apps://itunes.apple.com/nl/app/blackboard-mobile-learn/id1575199367?mt=8";
                }
                startApp
                  .set({
                    action: "ACTION_VIEW",
