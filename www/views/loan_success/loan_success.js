app.controller("loan_successCtrl", function ($scope, $rootScope, $state, $ionicPlatform) {
  ...
  $scope.$on("$ionicView.enter", function () {
    ...
    if (day == "Sunday" || day == "Saturday") {
      $rootScope.alert("Танд баярлалаа. Амралтын өдөр ажиллаж байгаа Банк, ББСБ-ууд Таны зээлийн хариуг өгнө. Бусад нь ажлын цаг эхэлмэгц хариу өгөх болохыг анхаараарай.", "success");
    } else if (hour > 9 && hour < 19) {
      $rootScope.alert("Танд баярлалаа. Таны хүсэлтэд тун удахгүй хариу өгөх болно.", "success");
    } else {
      $rootScope.alert("Танд баярлалаа. Ажлын цаг эхэлмэгц Таны зээлийн хүсэлтэд хариу өгөх болно.", "success");
    }
  });
});
